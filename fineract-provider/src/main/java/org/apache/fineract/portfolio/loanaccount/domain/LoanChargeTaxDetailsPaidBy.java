...
public class LoanChargeTaxDetailsPaidBy extends AbstractPersistable<Long> {
    ...
    public LoanChargeTaxDetailsPaidBy(final TaxComponent taxComponent, final BigDecimal amount){
